 ...
 * Raw Child.
 *
 * This file adds the required CSS to the front end to the Raw Child Theme.
 *
 * @package Raw Child
 * @author  rawsta
...
add_action( 'wp_enqueue_scripts', 'raw_child_css' );
/**
...
function raw_child_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'raw_child_logo_width', 350 );
