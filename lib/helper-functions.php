...
global $wp_embed;
add_filter( 'raw_child_the_content', array( $wp_embed, 'run_shortcode' ), 8 );
add_filter( 'raw_child_the_content', array( $wp_embed, 'autoembed'     ), 8 );
 ...
 *
 */
function raw_child_icon( $atts = array() ) {
