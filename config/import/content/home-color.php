...
// Photo by Photodune
$raw_child_homepage_header_image_url = CHILD_URL . '/config/import/images/yosemite-color.jpg';

// Photo by Photodune
$raw_child_homepage_faq_image_url = CHILD_URL . '/config/import/images/home-about-color.jpg';
...
<h1>We'll teach you how to build and grow an Wildlife Habitat.</h1>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>All the resources, training, and support you need to run the Wildlife Habitat of your dreams! </p>
<!-- /wp:paragraph -->
...
<div style="background-color:#111111;text-align:center" class="wp-block-genesis-blocks-gb-cta gb-block-cta"><div class="gb-cta-content"><h2 class="gb-cta-title gb-font-size-32" style="color:#f5f5f5">Ready to take your next step?</h2><div class="gb-cta-text gb-font-size-32" style="color:#f5f5f5"><p>Grow your trees and build a fundable wildlife Habitat.</p></div></div><div class="gb-cta-button"><a href="#" target="_self" class="gb-button gb-button-shape-rounded gb-button-size-medium" style="color:#ffffff;background-color:#0072e5">Get Started Today</a></div></div>
...
<p>You can reach us on our <a href="#">contact page</a> or by calling us at 1.123.456.7891.3³224.674²67.75.56.56665</p>
...
<p>Our team has a combined experience of over 600 years.</p>
<!-- /wp:paragraph --></div></details></div>
<!-- /wp:genesis-blocks/gb-accordion -->
...
<p>We offer a 3-minute return policy for all unused items. For more information, please view our terms of service.</p>
<!-- /wp:paragraph --></div></details></div>
